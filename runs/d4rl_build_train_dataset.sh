...
python -m src.data.prepare_d4rl_dataset \
  ...
  --out_dir outputs/d4rl_prepared_large_T128_train \
  --num_samples 10000 --hard_fraction 0.5 --T 128 --use_sdf 1 --d4rl_flip_y 0 \
  ...
  --episode_split_mod 10 --episode_split_val 1
