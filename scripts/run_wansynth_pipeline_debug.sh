...
FLOW_STEPS="${FLOW_STEPS:-2000}"
P1_STEPS="${P1_STEPS:-2000}"
P2_STEPS="${P2_STEPS:-2000}"
BATCH="${BATCH:-2}"
NUM_WORKERS="${NUM_WORKERS:-8}"
SHUFFLE_BUFFER="${SHUFFLE_BUFFER:-1000}"
ANCHOR_NUM_WORKERS="${ANCHOR_NUM_WORKERS:-0}"

FLOW_SAVE_EVERY="${FLOW_SAVE_EVERY:-500}"
P1_SAVE_EVERY="${P1_SAVE_EVERY:-500}"
P2_SAVE_EVERY="${P2_SAVE_EVERY:-500}"

FLOW_CKPT_DIR="${FLOW_CKPT_DIR:-checkpoints/latent_flow_interp_wansynth_debug}"
FLOW_LOG_DIR="${FLOW_LOG_DIR:-runs/latent_flow_interp_wansynth_debug}"
P1_CKPT_DIR="${P1_CKPT_DIR:-checkpoints/keypoints_wansynth_debug}"
P1_LOG_DIR="${P1_LOG_DIR:-runs/keypoints_wansynth_debug}"
ANCHOR_OUT="${ANCHOR_OUT:-data/wan_synth_anchors_debug}"
ANCHOR_JOIN="${ANCHOR_JOIN:-1}"
ANCHOR_KEY_BUFFER="${ANCHOR_KEY_BUFFER:-2000}"
P2_CKPT_DIR="${P2_CKPT_DIR:-checkpoints/interp_levels_wansynth_debug}"
P2_LOG_DIR="${P2_LOG_DIR:-runs/interp_levels_wansynth_debug}"

LORA_RANK="${LORA_RANK:-8}"
ANCHOR_DDIM_STEPS="${ANCHOR_DDIM_STEPS:-4}"
ANCHOR_MAX_BATCHES="${ANCHOR_MAX_BATCHES:-2}"
